...
typeof = setmetatable {
  ...
  --- List of type strings to data type representations.
  -- @within typeof
  -- @table datatypes
  datatypes: {}
...
--- Returns a datatype for a certain value, or false otherwise.
-- @param v Any value.
-- @treturn Type|false Returns the datatype, and otherwise false.
typefor = (v) -> typeof.datatypes[typeof v] or false
...
--- Resolves a string to a typeclass
-- @table classfor
classfor = setmetatable {}, __call: (s) => @[s]

--- Checks whether a value is an instance of a typeclass. **Curried function.**
-- @tparam Typeclass tc The base typeclass.
-- @param v The value to check.
-- @treturn boolean Whether it is an instance or not.
isInstanceOf = (tc) -> (v) ->
  if T = typefor v
    for tclass in *T.instanceOf
      return true if tclass == tc
    return false
  else false
